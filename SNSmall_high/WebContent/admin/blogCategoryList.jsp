		...
		<div class="row">
			...
			%>
                ...
                <%if(bb.getFile()!=null){ %>
                	...
                	<a href="./OurBlogPostAction.ad?num=<%=bb.getNum()%>&pageNum=<%=pageNum%>">
			...
			<%} %>
                ...
                <a class="btn btn-primary" href="./OurBlogPostAction.ad?num=<%=bb.getNum()%>&pageNum=<%=pageNum%>">Read More <span class="glyphicon glyphicon-chevron-right"></span></a>
...
<!-- Pager -->
	...
	%><a href="./OurBlogCategory.ad?category=<%=category %>&pageNum=<%=startPage-pageBlock%>">&larr; Older</a>
	<%
	}                   
	%>
		</li>
	...
	if(endPage<pageCount){
		%><a href="./OurBlogCategory.ad?category=<%=category %>&pageNum=<%=startPage+pageBlock%>">Newer &rarr;</a><%
	}
	%></li> 
	  </ul>
<%
