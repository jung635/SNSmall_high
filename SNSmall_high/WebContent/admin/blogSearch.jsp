	...
	%>
				...
				<% for(int i=0;i<blogList.size();i++){
	    			...
	    			<%if(bb.getFile()!=null){%>
		    			...
		    			<div class="col-lg-8" style="height: 40px; overflow: hidden;"><a href="./OurBlogPostAction.ad?num=<%=bb.getNum()%>&pageNum=<%=pageNum%>"><%=bb.getContent()%></a></div>...
...
if(count!=0){
	...
	if(startPage > pageBlock){
		%><a href="./OurBlogSearchAction.ad?search=<%=search %>&pageNum=<%=startPage-pageBlock%>">&larr; Older</a><%
	}                 
	%></li>
	...
	if(endPage<pageCount){
		%><a href="./OurBlogSearchAction.ad?search=<%=search %>&pageNum=<%=startPage+pageBlock%>">Newer &rarr;</a><%
	}
	%></li> </ul><%
}
%>
