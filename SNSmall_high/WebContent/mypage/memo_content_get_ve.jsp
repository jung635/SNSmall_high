...
<input type="button" value="쪽지목록" onclick="location.href='./MemoListGet_ve.me?pageNum=<%=pageNum%>'"></td></tr>
</table>

<form action="./MemoDeleteGet_veAction.me?pageNum=<%=pageNum %>" method="post" name="frmdelete" >
