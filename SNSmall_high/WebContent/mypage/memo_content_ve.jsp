...
<input type="button" value="쪽지목록" onclick="location.href='./MemoList_ve.me?pageNum=<%=pageNum%>'"></td></tr>
</table>

<form action="./MemoDelete_veAction.me?pageNum=<%=pageNum %>" method="post" name="frmdelete" >
