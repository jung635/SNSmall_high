...
List<PaymentBean> cancel_list = (List<PaymentBean>)request.getAttribute("list");
            ...
            <h2>취소 목록</h2>
            	...
            	<%}else{ %>
                  ...
                  for(int i=0; i<cancel_list.size(); i++){
                	  PaymentBean pb = cancel_list.get(i);
                  ...
                  <td><input type="button" value="취소 승인" onclick="location.href='PayCancel.ve?num=<%=pb.getNum()%>'"></td>
                  </tr>
                  <%} %>
                  </table>
                  <%} %>
