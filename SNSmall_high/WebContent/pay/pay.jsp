	    ...
	    if ( rsp.success ) {
	    	...
	    	$.ajax({
	    		...
	    		data: {
	        		...
	        		price_result : rsp.custom_data.price_result,
...
function deposit(){
	...
	point = document.getElementById('myPoint').innerText;
	message = document.getElementById('message').value;
	window.open("Deposit.pa?price="+price+"&merchant_uid="+merchant_uid+"&point="+point+"&message="+message+"&method="+method+"&price_result="+price_result, "Deposit" , "width=500,height=500");
}
