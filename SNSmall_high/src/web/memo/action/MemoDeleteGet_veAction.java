...
public class MemoDeleteGet_veAction implements Action{

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {

		//System.out.println("Memo Delete Get_ve execute()");
		...
		// check 1이면 "수정성공" 이동  ./MemoList.me?pageNum=
			...
			out.println("location.href='./MemoListGet_ve.me?pageNum="+pageNum+"';");
			out.println("</script>");
			out.close();
		return null;
	}
